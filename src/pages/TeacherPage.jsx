          ...
          <div style={{
            ...
            {Object.keys(studentFrames).length === 0 ? (
              <div style={{
                ...
                <div style={{ fontSize: '12px', marginTop: '4px' }}>Waiting for students to join...</div>
              </div>
            ) : (
              <div style={{
                display: 'grid',
                    ...
                    <div key={studentId} style={{
                      ...
                      <div style={{
                        ...
                        <span style={{
                          ...
                          borderRadius: '12px',
                          backgroundColor:
                            student?.status === 'attentive' ? '#22c55e' :
                            student?.status === 'drowsy' ? '#f59e0b' :
                            student?.status === 'looking_away' ? '#ef4444' : '#6b7280'
                        }}>
                          {student?.status === 'attentive' ? '✅' :
                           student?.status === 'drowsy' ? '😴' :
                           student?.status === 'looking_away' ? '👀' : '❓'}
                        </span>
                      </div>
                      <img
                        src={frame}
