    ...
    switch (message.type) {
      ...
      case 'alert':
        ...
        setAlerts(prev => {
          ...
          console.log('📊 Total alerts now:', updated.length);
          console.log('🔄 ALERTS STATE UPDATED:', updated.length, 'alerts');
          updated.forEach((alert, i) => {
            console.log(`  ${i + 1}. ${alert.student_name} - ${alert.alert_type} - ${alert.message}`);
          });
          return updated;
        });
        break;
      ...
      case 'clear_alert':
        ...
        setAlerts(prev => {
          ...
          console.log('🔄 ALERTS STATE UPDATED:', filtered.length, 'alerts');
          return filtered;
        });
        break;
